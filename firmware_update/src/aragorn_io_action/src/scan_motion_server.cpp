                ...
                case SequenceState::SCANING:
                    ...
                    else
                    {
                        ...
                        for(int i=0; i<NUMBER_PIR ; i++)
                        {
                            ...
                            {
                                scan_detected_counter_++;
                                ROS_INFO("[Scan_motion ActionServer]: Current step %d. Scan detect add flag %d", scan_detected_counter_);
                                if(scan_detected_counter_ >= 2)
                                {
                                    scan_result = ScanResult::SOMETHING_MOVE;
                                }
                                break;
