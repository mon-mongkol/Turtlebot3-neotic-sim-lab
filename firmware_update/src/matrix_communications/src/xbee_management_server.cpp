        ...
        {   
            ...
            switch(task_seq_)
            {
                ...
                case Task_Sequence::RobotConditionCheck:
                    ...
                    {
                        ROS_INFO("Robot number Matchhhh");
                ...
                case Task_Sequence::CmdSelector:
                    ROS_INFO("%s, %s", data_info_.cmd_string.c_str(), matrix_msgs::XbeeCommuROHM::route.c_str());
                    if(data_info_.cmd_string == matrix_msgs::XbeeCommuROHM::route)
                    {
                        ROS_INFO("IstRoads_NavGoal");
                        data_info_.cmd_uint = matrix_msgs::XbeeCommuROHM::CMD_ROUTE;
                ...
                {   
                    ...
                    goal.id = matrix_msgs::XbeeCommuROHM::IST_ROAD_ROUTE;
                    goal.cmd = "poi";
                    goal.from= "";
                    ...
                    {
                        ROS_ERROR("Not found POI name: %s", data_info_.poi_name);
                        task_seq_ = Task_Sequence::SendRespond;
                    }
        ...
        bool checkPOI(std::string poi_name)
        {
            ...
            if(layouts_srv_.call(layouts_srv))
            {
                ...
                {   
                    ...
                    if(POI_no_ == poi_name)
                    {
                        ROS_INFO("%s match with %s UILayout!!!", poi_name.c_str(), POI_no_.c_str() );
