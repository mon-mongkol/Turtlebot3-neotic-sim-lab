...
class ARFollower():
    ...
    def __init__(self, tag_id ,x_goal, y_goal):
        ...
        self.min_angular_speed = rospy.get_param("~min_angular_speed", 0.035)
        ...
        self.max_linear_speed = rospy.get_param("~max_linear_speed", 0.1) #0.073

        """ max_linear_vel: 0.10         # m/s, for parallel.c and steer
        min_linear_vel: 0.05        # m/s, for lastmile
        max_angular_vel: 0.12       # rad/s
