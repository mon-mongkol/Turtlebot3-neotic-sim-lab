...
#include <matrix_docking_ar_operation/DockingARConfig.h>
...
class ARDockingOperation
{
    protected:
        ...
        ros::ServiceClient docking_mode_sc, set_ios_sc, launch_controller_ac, motor_control_sc, autodock_sc;
        ros::Subscriber rs485_sub, serial_sub, batt_sub, odom_sub, robotmode_sub;
        ros::Publisher cmd_vel_pub, pause_dock_pub, busbar_pub;
        ...
        float cv_default_stop_dist_B = 0.0;
        float cv_default_right_offset = 0.0;
        float cv_default_left_offset = 0.0;
        int cv_default_timeout = 100;

        bool ar3_distance_from_dynamics = false;

        float ar3_docking_DARA = 0.1525;
        float ar3_docking_DARB = 0.130;

        dynamic_reconfigure::Server<matrix_docking_ar_operation::DockingARConfig> server;
        dynamic_reconfigure::Server<matrix_docking_ar_operation::DockingARConfig>::CallbackType f;
    ...
    public:
...

        {
            ...
            autodock_sc = nh_.serviceClient<dynamic_reconfigure::Reconfigure>("simple_autodock/set_parameters");
            ...
            busbar_pub = nh_.advertise<std_msgs::Bool>("/matrix_io/busbar", 1);
            ...
            ros::param::param<float>("~cv_stop_dist_B", cv_default_stop_dist_B, 0.4);
            ...
            ros::param::param<std::string>("~motor_model", motor_model, "matrix_navgo_controller");

            ros::param::param<bool>("~ar3_distance_from_dynamics", ar3_distance_from_dynamics, false);
            ros::param::param<float>("~ar3_docking_DARA", ar3_docking_DARA, 0.1525);
            ros::param::param<float>("~ar3_docking_DARB", ar3_docking_DARB, 0.13);
            ros::param::param<std::string>("~serial_no", serial_no, "SDR0100D2024B000201");
            ...
            f = boost::bind(&ARDockingOperation::dynamics_callback, this, _1, _2);
    ...
    private:
        ...
        void dynamics_callback(matrix_docking_ar_operation::DockingARConfig &config, uint32_t level);
        ...
        void SerialActionFindKey(std::string send, std::string receive, double timeout, bool repeat);
        ...
        void setBusbar(std::string mode);
