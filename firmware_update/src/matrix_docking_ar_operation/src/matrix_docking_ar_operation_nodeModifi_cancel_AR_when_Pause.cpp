#include "matrix_docking_ar_operation/matrix_docking_ar_operation_node.h"
    ...
    while(!finished)
    {
        ...
        switch(feedback_.sequence)
        {
            ...
            case ARDockingControlState::PAUSE:
                ...
                if((period_state >= ARDockingControlState::SEARCH_AR) && (period_state <= ARDockingControlState::WAIT_FINISH_AR_TRACKING))
                {
                    fnStop();
                ...
                if(current_robotmode != matrix_msgs::RobotMode::PAUSE)
                {
                    ...
                    {
                        // setDockingMode("on");
                        // feedback_.text = "back to Sear AR";
                        feedback_.sequence = ARDockingControlState::SEARCH_AR;
...
void ARDockingOperation::clear_params(void)
{
    //charger check state
