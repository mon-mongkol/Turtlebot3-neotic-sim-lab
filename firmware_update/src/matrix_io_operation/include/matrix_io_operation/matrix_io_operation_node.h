...
class IOOperation
{
    protected:
        ...
        ros::ServiceClient set_io_srv_, set_io_management;
    ...
    public:
              ...
              action_name_(name)
        {
            ...
            input_sub = nh_.subscribe("/matrix_io_management/user_cfg_state/input", 1 ,&IOOperation::cbMCU01Input, this);
            output_sub = nh_.subscribe("/matrix_io_management/user_cfg_state/output", 1 ,&IOOperation::cbMCU01Output, this);
            ...
            set_io_management = nh_.serviceClient<dynamic_reconfigure::Reconfigure>("/matrix_io_management/set_parameters");
        }
    ...
    private:
        ...
        void cbMCU01Input(const std_msgs::Int8MultiArray msg);
        void cbMCU01Output(const std_msgs::Int8MultiArray msg);
