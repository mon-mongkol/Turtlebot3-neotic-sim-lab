...
class Diagnostic
{
    protected:
        ...
        double wireless485_recive_stamp_,
            xbee_recive_stamp_,
            battplugin_recive_stamp_,
            camrear_recive_stamp_,
            cam3_recive_stamp_,
            wireless485_recive_stamp_old_,
            xbee_recive_stamp_old_,
            battplugin_recive_stamp_old_,
    ...
    public:
        Diagnostic()
        {
            ...
            ros::param::param<std::string>("~bms_topic", bms_topic, "/bms");
            ...
            sub_battery = nh_.subscribe(bms_topic, 10, &Diagnostic::cbBatteryState, this);
        ...
        {
            batt_recive_stamp_ = ros::Time::now().toSec();
            battery_state = msg;
        }
        ...
        void init_hardware_state()
        {
            ...
            battplugin_recive_stamp_ = ros::Time::now().toSec();
            xbee_recive_stamp_ = ros::Time::now().toSec();
            ...
            battplugin_recive_stamp_old_ = battplugin_recive_stamp_;
            xbee_recive_stamp_old_ = xbee_recive_stamp_;
        ...
        void diagnostics_device()
        {
            ...
            {
                //battery
                _isBattery = ((ros::Time::now().toSec() - batt_recive_stamp_) > timeout_error_device)? 2 : 0;
            ...
            {
                //battery
                _isBatteryPlugin = ((ros::Time::now().toSec() - battplugin_recive_stamp_) > timeout_error_device)? 2 : 0;
            ...
            if(check_xbee)
            {
                _isXbee = ((ros::Time::now().toSec() - xbee_recive_stamp_) > timeout_error_device)? 2 : 0;
            }
            else
            {
                _isXbee = 1;
        ...
        void diagnostics_pub()
        {
            ...
            diag_msg.device_state.lidar_front = _isLds_f;
            diag_msg.device_state.lidar_rear = _isLds_r;
            diag_msg.device_state.imu = _isIMU;
            diag_msg.device_state.camera_1 = _isCam1;
            diag_msg.device_state.camera_2 = _isCam2;
            diag_msg.device_state.bms = _isBattery;
            diag_msg.device_state.mcu_1 = _isMcu_1;
            diag_msg.device_state.motor = _isMotordrive;
