...
int main(int argc, char **argv)
{
    ...
    ros::init(argc, argv, "ist_layout_zones");
    ros::NodeHandle nh;
    ...
    web_interface_msgs::UILayout layout_searching;
    ...
    layout_searching.type = 34; // Searching zone,
    ...
    srv.request.layouts.push_back(layout_searching);
    ...
    while (nh.ok())
    {
        ...
        try
        {
            ...
            if (ready)
            {
                ...
                // srv.request.layouts.push_back(layout_poi);
